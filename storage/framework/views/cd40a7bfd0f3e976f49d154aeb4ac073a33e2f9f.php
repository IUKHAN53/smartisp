    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="float-right">
                <a class="btn btn-outline-info btn-sm" href="<?php echo e(url('/invoice')); ?>" role="button" title="" data-toggle="tooltip"
                   data-original-title="Add"><i class="ti-plus"></i>Generate Invoices</a>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\SmartISP\resources\views/billing/index.blade.php ENDPATH**/ ?>