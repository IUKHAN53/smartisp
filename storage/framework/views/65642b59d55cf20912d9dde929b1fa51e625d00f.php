    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="float-right">
                <a class="btn btn-outline-info" href="<?php echo e(route('franchise.create')); ?>" role="button" title="" data-toggle="tooltip"
                   data-original-title="Add"><i class="ti-plus"></i>Add new Franchise</a>
            </div>
                ...
                <table class="table color-bordered-table dark-bordered-table">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($d['franchise']->franchisename); ?></td>
                            <td><?php echo e($d['franchise']->mobile); ?></td>
                            <td><?php echo e($d['franchise']->address); ?></td>
                            <td><?php echo e($d['franchise']->prefix); ?></td>
                            <td>
                            ...
                            <td>
                                <form id="delete_form" action="<?php echo e(route('franchise.destroy', $d['franchise']->id)); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                </form>
                                <a class="btn btn-outline-cyan" role="button"
                                   href="<?php echo e(route('franchise.edit',$d['franchise']->id)); ?>" title="" data-toggle="tooltip"
                ...
                <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="modal"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Add user to Franchise</h4>
                                    <form id="userform">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IU KHAN\Documents\smartisp\resources\views/franchise/create.blade.php ENDPATH**/ ?>
