    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('leave.store')); ?>" id="user_form" method="POST" class="mt-4">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SmartISP\resources\views/hrm/leave/create.blade.php ENDPATH**/ ?>