...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function addvendor(){
            $.ajax({
                url: '<?php echo e(route('productvendor.store')); ?>',
                type:'POST',
                data:{
                    _token: CSRF_TOKEN,
                    name: $("#name").val(),
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iukha\Documents\Active Projects\smartisp\resources\views/inventory/product/vendor/create.blade.php ENDPATH**/ ?>
