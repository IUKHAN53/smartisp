        ...
        <div class="card-body">
            <form action="/ledgers/search" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <select class="form-control custom-select" name="account" data-placeholder="Choose a Category" tabindex="1">
                    ...
                    <div class="col-md-2">
                        <button type="submit" class="btn-lg btn-info">Generate Ledger</button>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iukha\Documents\Active Projects\smartisp\resources\views/account/ledgers/create.blade.php ENDPATH**/ ?>
