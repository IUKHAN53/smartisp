                    ...
                    <div class="user-pro-body">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu animated flipInY">
                                <a href="<?php echo e(url('/logout')); ?>" class="dropdown-item"><i class="fas fa-power-off"></i>Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo e(url('/permission')); ?>">Permissions</a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/billing')); ?>">View Billings</a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/pop')); ?>">Add POP</a></li>
                                    <li><a href="<?php echo e(url('/pop/create')); ?>">POP List</a></li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/franchise/create')); ?>">Add Franchise</a></li>
                                    <li><a href="<?php echo e(url('/franchise')); ?>">Franchise List</a></li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/zone')); ?>">View All</a></li>
                                    <li><a href="<?php echo e(url('/zone/create')); ?>">Add Zone</a></li>
                                    <li><a href="<?php echo e(url('/zone/create')); ?>">Zone Transfer</a></li>
                                    <li><a href="<?php echo e(url('/zone/create')); ?>">Zone Transfer History</a></li>
                                </ul>
                                <a href="javascript:void(0)"
                                   class="hide-menu" aria-expanded="false">Network Diagram</a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/server')); ?>">Monitor Network</a></li>
                                    <li><a href="<?php echo e(url('/optical')); ?>">Optical Network</a></li>
                                    <li><a href="<?php echo e(url('/box')); ?>">Add New Box</a></li>
                                    <li><a href="<?php echo e(url('/tjbox')); ?>">Add New TJ Box</a></li>
                                </ul>
                                <a href="javascript:void(0)"
                                   class="hide-menu" aria-expanded="false">FFTX</a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/zone')); ?>">Add New OLT</a></li>
                                    <li><a href="<?php echo e(url('/zone/create')); ?>">OLT List</a></li>
                                    <li><a href="<?php echo e(url('/zone/create')); ?>">Add Brand</a></li>
                                    <li><a href="<?php echo e(url('/zone/create')); ?>">Add Brand= List</a></li>
                                </ul>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/chartofaccounts/create')); ?>">Add</a></li>
                                    <li><a href="<?php echo e(url('/chartofaccounts')); ?>">View All</a></li>
                                    <li><a href="<?php echo e(url('/chartofaccounts/list')); ?>">List All</a></li>
                                </ul>
                                <a href="javascript:void(0)"
                                   class="hide-menu" aria-expanded="false">Accounts</a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href=/accounts/create>Add</a></li>
                                    <li><a href="<?php echo e(url('/accounts')); ?>">View All</a></li>
                                </ul>
                                <a href="javascript:void(0)"
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href='<?php echo e(url('/journals/create')); ?>'>Add</a></li>
                                    <li><a href="<?php echo e(url('/journals')); ?>">View All</a></li>
                                </ul>
                                <a href="javascript:void(0)"
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a href="<?php echo e(url('/productcategory')); ?>">Category</a></li>
                                    <li><a href="<?php echo e(url('/productvendor')); ?>">Vendor</a></li>'}}
                                    <li><a href="<?php echo e(url('/productbrand')); ?>">Brands</a></li>
                                    <li><a href="<?php echo e(url('/productunit')); ?>">Units</a></li>
                                    <li><a href="<?php echo e(url('/purchase')); ?>">Purchase Product</a></li>
                                </ul>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/customer')); ?>">View All</a></li>
                                <li><a href="<?php echo e(url('/customer/create')); ?>">Add User</a></li>
                                <li><a href="<?php echo e(url('/customertype')); ?>">View Customer Types</a></li>
                                <li><a href="<?php echo e(url('/customertype/create')); ?>">Add Customer Type</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                               aria-expanded="false"><i class="ti-pin"></i><span class="hide-menu">Police Station</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/policestation')); ?>">View All</a></li>
                                <li><a href="<?php echo e(url('/policestation/create')); ?>">Add Police Station</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                               aria-expanded="false"><i class="fas fa-location-arrow"></i><span class="hide-menu">District</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/district')); ?>">View All</a></li>
                                <li><a href="<?php echo e(url('/district/create')); ?>">Add District</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/upazila')); ?>">View All</a></li>
                                <li><a href="<?php echo e(url('/upazila/create')); ?>">Add UpaZila</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/sync')); ?>">Synchronize all</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/mikrotik')); ?>">View All</a></li>
                                <li><a href="<?php echo e(url('/mikrotik/create')); ?>">Add Mikrotik</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/hotspot')); ?>">Server List</a></li>
                                    <li><a href="<?php echo e(url('/hotspot/create')); ?>">Add Server</a></li>
                                </ul>
                                <a href="javascript:void(0)"
                                   class="hide-menu" aria-expanded="false">Users</a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/hotspotuser/create')); ?>">Add User</a></li>
                                    <li><a href="<?php echo e(url('/hotspotuser')); ?>">Users List</a></li>
                                    <li><a href="<?php echo e(url('/hotspotuser/batch')); ?>">Generate</a></li>
                                    <li><a href="<?php echo e(url('/hotspotuser/hosts')); ?>">Hosts</a></li>
                                </ul>
                                <a href="javascript:void(0)"
                                   class="hide-menu" aria-expanded="false">Profile</a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/hotspotprofile')); ?>">Profile List</a></li>
                                    <li><a href="<?php echo e(url('/hotspotprofile/create')); ?>">Add Profile</a></li>
                                </ul>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/dhcp')); ?>">View All</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/package')); ?>">View All</a></li>
                                <li><a href="<?php echo e(url('/package/create')); ?>">Add Package</a></li>
                                <li><a href="<?php echo e(url('/package/sync')); ?>">Sync Package</a></li>
                                <li><a href="<?php echo e(url('/package/sync')); ?>">Package Pricing</a></li>
                                <li><a href="<?php echo e(url('/package/sync')); ?>">Add Reseller Packages</a></li>
                                <li><a href="<?php echo e(url('/package/sync')); ?>">View Reseller Packages</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/ipaddress')); ?>">View All</a></li>
                                <li><a href="<?php echo e(url('/ipaddress/create')); ?>">Add IP Address</a></li>
                                <li><a href="<?php echo e(url('/ippool')); ?>">View IP POOLS</a></li>
                                <li><a href="<?php echo e(url('/ippool/create')); ?>">Add IP POOL</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                               aria-expanded="false"><i class="ti-link"></i><span class="hide-menu">Queue</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/queue')); ?>">View All Queue Simple</a></li>
                                <li><a href="<?php echo e(url('/queue/create')); ?>">Add Queue Simple</a></li>
                                <li><a href="<?php echo e(url('/queuetype')); ?>">View All Queue Type</a></li>
    ...
    $(document).ready(function () {
        ...
        for (var i = 0; i < noofanchors.length; i++) {
            $("#target" + i).click(function () {
                ...
                $.ajax({
                    method: 'POST',
                    url: '<?php echo e(url("/setsession/setActive")); ?>',
                    data: {
                        id: value,
                    },
...
<?php /**PATH C:\xampp2\htdocs\SmartISP\resources\views/layouts/template.blade.php ENDPATH**/ ?>