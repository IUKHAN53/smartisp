        ...
        <div class="col-12 ">
            <div class="card m-3 wizard-content">
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('customer.store')}}" id="user_form"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select class="custom-select form-control required" id="mikrotik"
                                            ...
                                            @foreach($mikrotiks as $mtk)
                                                <option value="{{$mtk['id']}}">{{$mtk['identity']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select form-control required" id="profile"
                                            ...
                                            @foreach($package as $pack)
                                                <option id="option" value="{{$pack['id']}}">{{$pack['name']}}
                                                    <small>({{$pack['synonym']}})</small></option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
