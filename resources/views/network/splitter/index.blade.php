...
@section('content')
    ...
    <div class="card m-3">
        <div class="card-body">
            ...
            <a href="" type="button" class="btn btn-outline-info"><i class="ti-list  mr-2"></i>Splitter List</a>
            <a href="" type="button" class="btn btn-outline-info"><i class="ti-list mr-2"></i>TJ List</a>
            <a href="" type="button" class="btn btn-outline-info"><i class="ti-plus mr-2"></i>Add OLT</a>
        </div>
    </div>
    <div class="card m-3">
        <div class="card-body">
