    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="float-right">
                <a class="btn btn-outline-info" href="{{route('franchise.create')}}" role="button" title="" data-toggle="tooltip"
            ...
            <div class="table-responsive">
                <table class="table color-bordered-table dark-bordered-table">
                    ...
                    @foreach($data as $d)
                        <tr>
                            <td>{{ $counter++ }}</td>
                            <td>{{ $d['franchise']->franchisename }}</td>
                            <td>{{ $d['franchise']->mobile }}</td>
                            <td>{{ $d['franchise']->address }}</td>
                            <td>
                            ...
                            <td>
                                <form id="delete_form" action="{{ route('franchise.destroy', $d['franchise']->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                </form>
                                <a class="btn btn-outline-cyan" role="button"
                                   href="{{ route('franchise.edit',$d['franchise']->id)}}" title="" data-toggle="tooltip"
